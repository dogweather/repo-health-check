...
(function() {
  describe("Metrics", function() {
    ...
    describe(".effectiveness_desc()", function() {
      it("handles a range from 0 to 10", function() {
        ...
        return expect(Metrics.effectiveness_desc(10)).toBe("Super effective");
      });
  ...
  describe("App.Github", function() {
    ...
    return describe(".parseRepoInput()", function() {
      xit("parses a project URL", function() {
      ...
      return xit("parses a repo spec", function() {
