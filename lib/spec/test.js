...
(function() {
  ...
  describe("App.Github", function() {
    ...
    return describe(".pageCount(apiResult)", function() {
      it("can parse a result correctly", function() {
        var result;
        result = {
      ...
      return it("returns null when info is not present", function() {
        return expect(App.Github.pageCount({})).toBe(null);
      });
    });
  });
